...
__all__ = [
    'DISPID_SRGetPropertyString', 'SAFTDefault', 'DISPID_SGRSTsItem',
    'SPEI_RESERVED6', 'DISPID_SpeechPhraseElement',
    'SpeechStreamFileMode', 'DISPID_SLAddPronunciation',
    'SPGRAMMARWORDTYPE', 'DISPID_SRAudioInputStream',
    'DISPID_SOTCategory', 'SAFTCCITT_uLaw_44kHzStereo', 'SP_VISEME_7',
    'SpMMAudioOut', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SGRSTWeight', 'DISPID_SpeechRecognizer',
    'eLEXTYPE_USER_SHORTCUT', 'SVEStartInputStream',
    'DISPID_SLPLangId', 'ISpObjectWithToken', 'SAFT24kHz16BitMono',
    'eLEXTYPE_PRIVATE8', 'DISPID_SLPsCount', 'DISPID_SFSOpen',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SP_VISEME_15',
    'DISPID_SCSBaseStream', 'STCRemoteServer',
    'DISPID_SAFGetWaveFormatEx', 'SPVISEMES', 'SSSPTRelativeToStart',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPRNumberOfElements',
    'DISPID_SPRuleNumberOfElements', 'SpeechRuleState',
    'DISPID_SRIsShared', 'SDTAll', 'SASRun', 'ISpNotifyTranslator',
    'DISPID_SPIGrammarId', 'DISPID_SRCERecognition', 'SPPS_Modifier',
    'DISPID_SRProfile', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SpeechGrammarRule', 'SVP_18', 'DISPID_SRCEEndStream',
    'ISpEventSink', 'SWPKnownWordPronounceable',
    'DISPID_SVSLastBookmark', 'DISPID_SLPs_NewEnum',
    'DISPID_SpeechXMLRecoResult', 'SP_VISEME_9', 'SASPause',
    ...
    'SPSERIALIZEDRESULT', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRGCmdLoadFromFile', 'SREPropertyStringChange',
    'ISpNotifySink', 'SVP_11', 'SAFT48kHz16BitMono', 'SVSFlagsAsync',
    'DISPID_SGRAddResource', 'DISPID_SOTId', 'DISPID_SRState',
    'eLEXTYPE_PRIVATE11', 'SP_VISEME_4', 'SITooLoud',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechLexiconWord', 'SPBO_AHEAD', 'SVP_10', 'SVP_9',
    'SP_VISEME_20', 'ISpeechAudio', 'SVSFPurgeBeforeSpeak',
    'SPPS_Noun', 'SRTEmulated', 'DISPID_SASNonBlockingIO',
    'SPEI_INTERFERENCE', 'SPAUDIOSTATUS', 'SpeechCategoryAppLexicons',
    'SVP_14', 'Speech_StreamPos_Asap', 'SREAdaptation', 'SPAR_Low',
    'SPWF_INPUT', 'eLEXTYPE_RESERVED4', 'ISpeechPhraseReplacement',
    'SPEI_FALSE_RECOGNITION', 'SPEI_MIN_SR',
    'DISPID_SVSLastStreamNumberQueued', 'SVP_12', 'SVSFDefault',
    'SPAR_High', 'ISpSerializeState', 'DISPID_SRSSupportedLanguages',
    'SpeechAudioVolume', 'DISPID_SpeechPhraseProperties',
    ...
    'SPVPRIORITY', 'SPINTERFERENCE_NOISE', 'DISPID_SGRSTRule',
    'SVP_15', 'SAFT48kHz16BitStereo',
    'SpeechPropertyHighConfidenceThreshold', 'SPRS_INACTIVE',
    'SVPAlert', 'DISPID_SGRAddState', 'DISPID_SLPPartOfSpeech',
    'DISPID_SpeechRecoContext', 'DISPID_SOTGetDescription',
    'DISPID_SOTsItem', 'DISPID_SPEPronunciation',
    'eLEXTYPE_PRIVATE20', 'STSF_CommonAppData', 'SPBOOKMARKOPTIONS',
    'SAFTExtendedAudioFormat', 'SP_VISEME_0',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVSInputWordLength',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPCIdToPhone',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SPIGetText',
    'DISPID_SDKGetStringValue', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPEI_START_INPUT_STREAM', 'SAFTGSM610_44kHzMono',
    'SPCT_SUB_DICTATION', 'DISPID_SRGDictationUnload',
    'DISPID_SLPsItem', 'SpeechDictationTopicSpelling', 'SVP_16',
    'SVF_None', 'ISpeechTextSelectionInformation',
    'SPRECOCONTEXTSTATUS', 'DISPID_SRCERecognizerStateChange',
    'SSTTWildcard', 'DISPID_SVEEnginePrivate',
    ...
    'SPEI_SR_AUDIO_LEVEL', 'SPFM_CREATE', 'DISPID_SGRSTType',
    'SpeechDataKeyLocation', 'SpeechInterference', 'SPAS_CLOSED',
    'SPPHRASEPROPERTY', 'eLEXTYPE_RESERVED7',
    'SpeechDisplayAttributes', 'Speech_Default_Weight',
    'DISPID_SASCurrentSeekPosition', 'SPPHRASEELEMENT',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SP_VISEME_3', 'ISpeechVoice',
    'DISPID_SBSRead', 'ISpeechRecoResultDispatch',
    'SpeechPropertyResponseSpeed', 'SAFTADPCM_8kHzStereo',
    'DISPID_SABufferInfo', 'SREStreamStart', 'DISPID_SRCEHypothesis',
    'SGDSActiveWithAutoPause', 'SPAS_PAUSE', 'SVSFIsFilename',
    'SpeechVisemeFeature', 'SVF_Stressed', 'DISPID_SPPConfidence',
    'DISPID_SAFType', 'DISPID_SVEViseme', 'DISPID_SPAsItem',
    'SPDKL_CurrentUser', 'DISPID_SPPs_NewEnum', 'SRTExtendableParse',
    'DISPID_SBSFormat', 'SAFTGSM610_22kHzMono', 'SpeechRunState',
    'SpeechPropertyAdaptationOn', 'SRTAutopause',
    'ISpeechAudioBufferInfo', 'SGDisplay', 'SAFT12kHz16BitStereo',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SRSEIsSpeaking', 'DISPID_SPEsItem',
    'SAFTCCITT_ALaw_22kHzStereo', 'SpeechPartOfSpeech',
    'eLEXTYPE_PRIVATE15', '__MIDL_IWinTypes_0009',
    'DISPID_SWFEAvgBytesPerSec', 'SASStop', 'SPVPRI_OVER',
    'ISpEventSource', 'IInternetSecurityManager', 'ISpeechRecoResult',
    'ISpeechRecognizer', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SVSpeak', 'DISPID_SVRate', 'SDA_No_Trailing_Space',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SGLexicalNoSpecialChars',
    'DISPID_SGRsFindRule', 'eLEXTYPE_MORPHOLOGY', 'SPPS_LMA',
    'ISpRecoResult', 'SpeechRegistryLocalMachineRoot', 'SPEI_MAX_SR',
    'DISPID_SRSAudioStatus', 'SRTReSent',
    ...
    'DISPID_SPEsCount', 'SAFTCCITT_ALaw_44kHzStereo', 'SPRS_ACTIVE',
    'DISPID_SOTRemove', 'DISPID_SpeechObjectToken', 'SVSFParseSapi',
    'DISPID_SPARecoResult', 'DISPID_SPRuleName',
    'SpeechWordPronounceable', 'SPVPRI_ALERT',
    'DISPID_SPEDisplayText', 'SPWORDPRONUNCIATION',
    'DISPID_SpeechVoiceStatus', 'SAFT22kHz8BitStereo',
    'SECLowConfidence', 'SGRSTTWord', 'DISPID_SRGSetTextSelection',
    'SPAS_STOP', 'SAFT12kHz8BitStereo', 'SAFTGSM610_11kHzMono',
    'DISPID_SFSClose', 'SPPS_SuppressWord', 'SPEI_RECOGNITION',
    'SPLOADOPTIONS', 'DISPID_SOTDataKey', 'DISPID_SABufferNotifySize',
    'DISPID_SVVolume', 'DISPID_SpeechPhraseAlternates',
    'ISpRecoGrammar2', 'SGRSTTDictation', 'SPADAPTATIONRELEVANCE',
    'SGPronounciation', 'DISPID_SVEAudioLevel',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SGRSTs_NewEnum',
    'SRSEDone', 'eLEXTYPE_RESERVED6',
    'SpeechGrammarRuleStateTransitionType', 'SP_VISEME_14',
    'DISPID_SDKGetlongValue', 'SAFT8kHz8BitMono', 'SPWT_DISPLAY',
    'eLEXTYPE_PRIVATE13', 'SP_VISEME_13', 'SINoise',
    'DISPID_SRCVoice', 'SpeechTokenIdUserLexicon',
    'DISPID_SDKDeleteKey', 'ISpeechLexiconWords',
    '_ISpeechVoiceEvents', 'DISPID_SRCEPropertyStringChange',
    'SAFT12kHz8BitMono', 'DISPID_SDKGetBinaryValue', 'DISPID_SVEWord',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpeechResourceLoader',
    'SpeechCategoryVoices', 'SAFTCCITT_uLaw_8kHzStereo',
    'SRSInactiveWithPurge', 'DISPID_SAFSetWaveFormatEx',
    'SpWaveFormatEx', 'SP_VISEME_1', 'DISPID_SPIReplacements',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SABIEventBias',
    'SPGRAMMARSTATE', 'SGRSTTWildcard',
    'SpeechPropertyComplexResponseSpeed', 'SPCS_ENABLED',
    'SVF_Emphasis', 'DISPID_SADefaultFormat',
    'DISPID_SPISaveToMemory', 'SVP_17', 'SpeechVisemeType',
    'DISPID_SOTCGetDataKey', 'SPWORDLIST', 'DISPID_SVDisplayUI',
    'eLEXTYPE_PRIVATE1', 'SAFTGSM610_8kHzMono', 'DISPID_SpeechVoice',
    'SRCS_Disabled', 'DISPID_SpeechRecognizerStatus', 'SP_VISEME_12',
    'ISpPhrase', 'SSTTDictation', 'SPINTERFERENCE_NONE',
    'SAFT8kHz8BitStereo', 'SGSDisabled', 'SP_VISEME_5', 'SPLO_STATIC',
    'SAFTADPCM_8kHzMono', 'DISPID_SPRsCount',
    'DISPID_SpeechPhraseRules', 'SPBO_PAUSE', 'DISPID_SVResume',
    'SPEI_START_SR_STREAM', 'DISPID_SDKSetLongValue',
    'SAFT44kHz16BitStereo', 'SpeechMicTraining', 'SDTPronunciation',
    'DISPID_SMSALineId', 'SAFT16kHz8BitMono', 'SPFILEMODE',
    'SpCustomStream', 'Speech_Max_Pron_Length', 'SPPHRASERULE',
    'DISPID_SRCEInterference', 'DISPID_SLWType',
    'SGDSActiveUserDelimited', 'SVESentenceBoundary',
    'DISPID_SVWaitUntilDone', 'DISPID_SRCEAdaptation',
    'SPSNotOverriden', 'SpeechStreamSeekPositionType',
    'DISPID_SRGetFormat', 'DISPID_SRIsUISupported', 'SPPS_Function',
    'DISPID_SRGCmdSetRuleState', 'SPSERIALIZEDPHRASE',
    'DISPID_SPIAudioSizeTime', 'ISpXMLRecoResult',
    'DISPID_SRGetPropertyNumber', 'DISPID_SVSInputSentencePosition',
    'SAFTADPCM_11kHzStereo', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SGRsDynamic', 'SP_VISEME_8', 'SVEPrivate',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SGRsItem',
    'SPWT_PRONUNCIATION', 'SPCATEGORYTYPE', 'SpPhoneConverter',
    'SPRST_ACTIVE', 'SECFNoSpecialChars', 'SPBINARYGRAMMAR',
    'SPDKL_LocalMachine', 'SPEVENT', 'SPPS_RESERVED3', 'ISpStream',
    'DISPID_SVGetVoices', 'SPEI_SR_RETAINEDAUDIO',
    'SECFEmulateResult', 'SP_VISEME_17',
    'DISPID_SLGetGenerationChange', 'eLEXTYPE_PRIVATE9', 'SBONone',
    'SPSHT_NotOverriden', 'SPFM_OPEN_READONLY', 'SPPS_RESERVED4',
    'DISPID_SPPName', 'DISPID_SRCRetainedAudioFormat', 'SpVoice',
    'SDTReplacement', 'SREPropertyNumChange', 'SPEI_WORD_BOUNDARY',
    'DISPID_SpeechMemoryStream', 'SAFTADPCM_22kHzStereo', 'SDTAudio',
    'DISPID_SPRulesItem', 'IStream', 'DISPID_SpeechDataKey', 'SVP_5',
    'SRAImport', 'SpeechRecoEvents', 'DISPID_SRRTStreamTime',
    'SPRECORESULTTIMES', 'DISPID_SVESentenceBoundary',
    'SPSHORTCUTPAIRLIST', 'ISpeechGrammarRules',
    'DISPID_SVEVoiceChange', 'SDTRule', 'SREPrivate',
    'ISpeechBaseStream', 'DISPID_SRCBookmark',
    'DISPID_SRGCmdSetRuleIdState', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SLPSymbolic', 'DISPID_SOTSetId', 'SPGS_EXCLUSIVE',
    'SREPhraseStart', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SpeechObjectTokens', 'ISpRecoCategory',
    'ISpeechRecognizerStatus', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SPACommit', 'DISPID_SPEAudioSizeBytes', 'DISPID_SOTCId',
    'SpMMAudioIn', 'SPRST_ACTIVE_ALWAYS', 'SP_VISEME_2',
    'DISPID_SPPValue', 'DISPID_SGRClear', 'SPVOICESTATUS',
    'SPWAVEFORMATTYPE', 'eLEXTYPE_PRIVATE2', 'DISPID_SVSLastResult',
    'eLEXTYPE_RESERVED10', 'DISPID_SVSInputSentenceLength',
    'SPSMF_UPS', 'DISPID_SAFGuid', 'SPRULESTATE',
    'DISPID_SRGDictationLoad', 'SpPhoneticAlphabetConverter',
    'SpeechGrammarState', 'ISpeechLexiconPronunciations',
    'DISPID_SMSADeviceId',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SLPType', 'ISpeechPhraseReplacements', 'SpLexicon',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPILanguageId',
    ...
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPWF_SRENGINE',
    'SpeechTokenValueCLSID', 'DISPIDSPTSI', 'SAFT44kHz8BitStereo',
    'SPSNoun', 'DISPID_SGRSTPropertyValue', 'DISPID_SPRs_NewEnum',
    'DISPID_SRCRequestedUIType', 'SECFIgnoreWidth',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPRFirstElement',
    'SPEI_VOICE_CHANGE', '_RemotableHandle', 'ISpGrammarBuilder',
    'SPVPRI_NORMAL', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SPIProperties', 'SPEI_HYPOTHESIS', 'SPPS_NotOverriden',
    'ISpeechPhraseAlternates', 'SpeechTokenKeyUI', 'DISPID_SOTCSetId',
    'DISPID_SVSPhonemeId', '_SPAUDIOSTATE',
    'ISpeechObjectTokenCategory', 'SRERecoOtherContext',
    'DISPID_SPPsItem', 'SPRULE', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRGRecoContext', 'SPSEMANTICFORMAT',
    'DISPID_SVGetAudioInputs', 'SpeechAudioFormatType',
    'SAFTCCITT_uLaw_22kHzMono', 'SVSFIsNotXML', 'SVPNormal',
    'DISPID_SPIRule', 'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRSRule',
    'ISpStreamFormatConverter', 'SPSTREAMFORMATTYPE',
    'ISpeechMMSysAudio', 'DISPID_SRRAudioFormat',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SRCESoundEnd',
    'DISPID_SGRSTNextState', 'SpStream', 'SRTSMLTimeout',
    'SpeechLexiconType', 'SpFileStream', 'SPINTERFERENCE_TOOQUIET',
    'SPPARTOFSPEECH', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SVSpeakStream', 'SPPS_RESERVED2', 'eLEXTYPE_PRIVATE5',
    'SPAUDIOBUFFERINFO', 'SpNullPhoneConverter', 'SPPS_Unknown',
    'SpObjectToken', 'SPWT_LEXICAL', 'SPEI_RESERVED5',
    'DISPID_SOTs_NewEnum', 'STSF_FlagCreate',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechMemoryStream',
    'SPAO_RETAIN_AUDIO', 'SAFTCCITT_uLaw_11kHzStereo',
    'eLEXTYPE_PRIVATE19', 'SRAExport', 'SSFMOpenForRead',
    'SPAUDIOOPTIONS', 'DISPID_SRSetPropertyString',
    'SpResourceManager', 'ISpeechRecoContext', 'SDTProperty',
    'DISPID_SPIElements', 'DISPID_SpeechLexiconProns',
    'ISpObjectToken', 'SREAudioLevel', 'DISPID_SpeechFileStream',
    'ISpPhoneConverter', 'ISpeechXMLRecoResult', 'DISPID_SVPriority',
    'SVSFVoiceMask', 'SpeechCategoryAudioIn', 'SAFTNoAssignedFormat',
    'SAFT24kHz8BitStereo', 'SAFT32kHz8BitStereo', 'DISPID_SVVoice',
    'SpeechTokenKeyFiles', 'SDTLexicalForm', 'DISPID_SAEventHandle',
    'SVEEndInputStream', 'SRCS_Enabled', 'SFTSREngine',
    'DISPID_SRRecognizer', 'DISPID_SpeechCustomStream',
    'tagSPPROPERTYINFO', 'SRSActive',
    'DISPID_SRCCreateResultFromMemory',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRGDictationSetState', 'SPEI_TTS_AUDIO_LEVEL',
    'SPRECOSTATE', 'DISPID_SGRName', 'eLEXTYPE_APP',
    'DISPID_SGRSTPropertyId', 'DISPID_SRRTTickCount', 'SPWORD',
    'DISPID_SGRSTsCount', 'eLEXTYPE_PRIVATE10', 'SVSFNLPMask',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPIStartTime',
    'DISPID_SpeechPhraseReplacements',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SINone', 'SVP_8',
    'SpeechVoiceSkipTypeSentence',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SSFMCreate',
    'SPCS_DISABLED', 'SPXMLRESULTOPTIONS', 'SAFT32kHz16BitStereo',
    'SpeechRecoContextState', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SWFEBitsPerSample', 'SRADynamic',
    'SpTextSelectionInformation', 'DISPID_SREmulateRecognition',
    'SWTAdded', 'SpObjectTokenCategory',
    'SpeechEmulationCompareFlags', 'SVSFIsXML', 'DISPID_SRStatus',
    'STCAll', 'SPSHORTCUTTYPE', 'SVP_19',
    'DISPID_SOTMatchesAttributes', 'SpeechAllElements',
    'SAFT32kHz8BitMono', 'ISpeechAudioFormat', 'SREStateChange',
    'SpeechAudioState', 'ISpeechLexicon', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRCRecognizer', 'ISpeechRecoResult2',
    'DISPID_SPRuleConfidence', 'DISPID_SRGetRecognizers',
    'DISPID_SpeechLexicon', 'ISpeechPhraseProperty',
    'SWPUnknownWordUnpronounceable', 'DISPID_SVEPhoneme',
    'DISPID_SGRSAddWordTransition', 'SPSHT_OTHER', 'DISPID_SAStatus',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SRRTOffsetFromStart',
    'ISpeechRecoGrammar', 'DISPID_SVEBookmark', 'SPEI_TTS_PRIVATE',
    'ISpeechFileStream', 'SPRST_INACTIVE', 'SREBookmark',
    'DISPID_SRRGetXMLResult', 'ISpPhoneticAlphabetSelection',
    'SREInterference', 'SPEI_END_INPUT_STREAM', 'tagSTATSTG',
    'SpeechAudioFormatGUIDWave', 'SpeechCategoryPhoneConverters',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRCERequestUI', 'SP_VISEME_18',
    'SSTTTextBuffer', 'DISPID_SPRuleFirstElement', 'DISPID_SLWWord',
    'SVSFUnusedFlags', 'DISPID_SpeechRecoResult', 'SAFT8kHz16BitMono',
    'DISPID_SRSetPropertyNumber', 'DISPID_SGRsAdd',
    'DISPID_SPEDisplayAttributes', 'eLEXTYPE_PRIVATE7',
    'SRSActiveAlways', 'SPEVENTENUM', 'DISPID_SPRsItem',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SLRemovePronunciation',
    'ISpProperties', 'eLEXTYPE_LETTERTOSOUND', 'SITooSlow',
    'SpeechTokenKeyAttributes', 'SPCT_SUB_COMMAND',
    'DISPID_SLGenerationId', 'SDA_One_Trailing_Space',
    'SPEI_END_SR_STREAM', 'DISPID_SGRsCommitAndSave',
    'SPDATAKEYLOCATION', 'DISPID_SDKSetStringValue', 'SINoSignal',
    'DISPID_SRRAudio', 'SPEI_SR_PRIVATE', 'eLEXTYPE_RESERVED8',
    'DISPID_SPELexicalForm', 'ISpeechVoiceStatus', 'SVP_21',
    'DISPID_SPAPhraseInfo', 'SAFT24kHz8BitMono',
    'SpeechVoiceSpeakFlags', 'DISPID_SPIEnginePrivateData',
    'SRAONone', 'ISpeechPhraseInfo', 'DISPID_SMSAMMHandle',
    'DISPID_SABIBufferSize', 'DISPID_SRGState', 'SAFT16kHz8BitStereo',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SpeechAudio',
    'DISPID_SpeechGrammarRules', 'ISpeechPhraseElement', 'SPAO_NONE',
    'SPINTERFERENCE', 'SVP_20', 'DISPID_SOTsCount',
    'DISPID_SpeechObjectTokenCategory', 'SpeechGrammarWordType',
    'SpeechRegistryUserRoot', 'SPCT_SLEEP', 'SVSFParseAutodetect',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SLWLangId',
    'DISPID_SPRText', 'SVP_0', 'SAFT11kHz8BitMono', 'SRATopLevel',
    'DISPIDSPTSI_SelectionOffset', 'ISpRecoGrammar',
    'DISPID_SpeechPhraseInfo', 'SAFTADPCM_11kHzMono',
    'ISpeechGrammarRule', 'SPCONTEXTSTATE', 'DISPID_SVSVisemeId',
    'SpeechEngineProperties', 'ISpeechWaveFormatEx',
    'DISPID_SWFEChannels', 'DISPID_SDKCreateKey',
    'DISPID_SRCEPhraseStart', 'DISPID_SGRSAddSpecialTransition',
    'SAFT48kHz8BitMono', 'SPEI_SOUND_START', 'DISPID_SPEs_NewEnum',
    'DISPID_SGRsCommit', 'SPEI_REQUEST_UI', 'DISPID_SPEAudioSizeTime',
    'ISpeechAudioStatus', 'eWORDTYPE_ADDED', 'SPEI_MAX_TTS',
    'DISPID_SPPBRestorePhraseFromMemory', 'STSF_AppData',
    'SAFT24kHz16BitStereo', 'SPAS_RUN', 'SpMemoryStream',
    'DISPID_SASetState', 'SPEI_PHRASE_START', 'DISPID_SDKEnumValues',
    'DISPID_SpeechMMSysAudio', 'eLEXTYPE_PRIVATE6', 'SVEAllEvents',
    ...
    'DISPID_SGRAttributes', 'SPSHORTCUTPAIR', 'SPAR_Medium',
    'SP_VISEME_11', 'SDTDisplayText', 'DISPID_SAVolume',
    'DISPID_SVSInputWordPosition', 'DISPID_SVSLastBookmarkId',
    'SAFTText', 'SRERequestUI', 'DISPID_SRGCmdLoadFromResource',
    'ISpeechRecoResultTimes', 'SAFT22kHz8BitMono',
    'SPEVENTSOURCEINFO', 'Speech_Max_Word_Length', 'ISpeechDataKey',
    'eLEXTYPE_PRIVATE16', 'ISpMMSysAudio', 'DISPID_SLGetWords',
    'SpeechTokenContext', 'SVP_3', 'SPLO_DYNAMIC',
    'DISPID_SLWPronunciations', 'SpSharedRecognizer', 'SVPOver',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SOTDisplayUI',
    'DISPID_SpeechAudioStatus', 'STCLocalServer', 'DISPID_SRGReset',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPPHRASEREPLACEMENT',
    'SPFM_OPEN_READWRITE', 'ISpPhraseAlt', 'DISPID_SGRsCount',
    'SpeechRetainedAudioOptions', 'SECFIgnoreCase', 'SPAR_Unknown',
    'ISpVoice', 'SVP_6', 'DISPID_SRCESoundStart',
    'ISpeechGrammarRuleStateTransitions', 'SPINTERFERENCE_NOSIGNAL',
    'SREStreamEnd', 'SPSLMA', 'eLEXTYPE_PRIVATE12',
    'SPXRO_Alternates_SML', 'SVEViseme', 'SpPhraseInfoBuilder',
    'eLEXTYPE_PRIVATE4', 'DISPID_SMSGetData', 'SSFMCreateForWrite',
    'SAFT44kHz8BitMono', 'DISPID_SVSRunningState', 'DISPID_SPCLangId',
    'SREHypothesis', 'DISPID_SVSCurrentStreamNumber', 'DISPID_SRGId',
    'SRARoot', 'DISPID_SpeechPhraseElements', 'DISPID_SWFEExtraData',
    'ISpeechObjectToken', 'SPWORDPRONOUNCEABLE', 'SDTAlternates',
    'SpeechRecoProfileProperties', 'IEnumSpObjectTokens',
    'SVEPhoneme', 'SPFM_NUM_MODES', 'DISPID_SRRSetTextFeedback',
    'SPSHT_Unknown', 'SDKLCurrentConfig', 'SAFT48kHz8BitStereo',
    'DISPID_SRCRetainedAudio', 'SpeechVoicePriority',
    'ISpNotifySource', 'DISPIDSPTSI_ActiveLength',
    'SpCompressedLexicon', 'DISPID_SRSCurrentStreamPosition',
    'SpeechFormatType', 'SPEI_SR_BOOKMARK',
    'SpeechSpecialTransitionType', 'SPLEXICONTYPE', 'SVEVoiceChange',
    'ISpPhoneticAlphabetConverter', 'ISpShortcut',
    'DISPID_SPCPhoneToId', 'ISpRecognizer', 'SP_VISEME_21',
    'STSF_LocalAppData', 'DISPID_SVPause', 'ISpRecoContext',
    'ISpeechGrammarRuleState', 'DISPID_SLWs_NewEnum',
    'DISPID_SVSpeakCompleteEvent', 'SAFT32kHz16BitMono',
    'SRESoundEnd', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SOTCDefault', 'SFTInput', 'ISpeechPhraseRule',
    'DISPID_SVSkip', 'eLEXTYPE_USER', 'SVSFParseMask',
    'SPGS_DISABLED', 'DISPID_SPRulesCount', 'ISpResourceManager',
    'DISPID_SWFEBlockAlign', 'DISPID_SLPPhoneIds',
    'DISPID_SRRTLength', 'eLEXTYPE_PRIVATE18', 'SVP_13',
    'SGRSTTEpsilon', 'LONG_PTR', 'DISPID_SPRDisplayAttributes',
    'DISPID_SVGetProfiles', 'ISpObjectTokenCategory', 'SVSFParseSsml',
    'DISPID_SpeechLexiconWords', 'SECFIgnoreKanaType',
    ...
    'DISPID_SRCEBookmark', 'SpeechPropertyNormalConfidenceThreshold',
    'SpeechRecognitionType', 'SAFT16kHz16BitMono',
    ...
    'SPWORDTYPE', 'SSFMOpenReadWrite', 'SAFTADPCM_44kHzMono',
    'SVSFPersistXML', 'DISPID_SpeechVoiceEvent',
    'SpeechCategoryAudioOut', 'DISPID_SRCEPropertyNumberChange',
    'SPCT_DICTATION', 'SASClosed', 'DISPID_SPRuleId',
    'SpeechWordType', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPRuleChildren', 'SGSExclusive', 'SpAudioFormat',
    'DISPID_SLWsItem', 'DISPID_SASFreeBufferSpace',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SASState',
    'DISPID_SVEStreamEnd', 'DISPID_SRCEEnginePrivate',
    'SPEI_RESERVED2', 'ISpeechObjectTokens', 'SPINTERFERENCE_TOOLOUD',
    'SPINTERFERENCE_TOOFAST', 'SVEBookmark',
    'SpeechAudioFormatGUIDText', 'SECFDefault', 'DISPID_SBSWrite',
    'SRSInactive', 'DISPID_SPAStartElementInResult', 'SGRSTTRule',
    'SAFTCCITT_ALaw_44kHzMono', 'SPWORDPRONUNCIATIONLIST',
    'SRAORetainAudio', 'DISPID_SPAs_NewEnum', 'DISPID_SDKDeleteValue',
    'DISPID_SVStatus', 'SPAUDIOSTATE', 'DISPID_SPEEngineConfidence',
    'DISPID_SPIRetainedSizeBytes', 'IInternetSecurityMgrSite',
    'SRERecognition', 'SPFM_CREATE_ALWAYS', 'DISPID_SGRSTransitions',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPPFirstElement',
    'ISpAudio', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPSEMANTICERRORINFO', 'SPPS_Interjection', 'SPEI_UNDEFINED',
    'DISPID_SRSClsidEngine', 'SpeechRecognizerState',
    'DISPID_SRCCmdMaxAlternates', 'DISPIDSPRG',
    'DISPID_SpeechPhoneConverter', 'ISpRecognizer2',
    'SSSPTRelativeToCurrentPosition', 'SSSPTRelativeToEnd',
    'DISPID_SRCEAudioLevel', 'SPEI_PROPERTY_NUM_CHANGE',
    'SDKLDefaultLocation', 'DISPID_SVAlertBoundary',
    'SDKLLocalMachine', 'SPEI_RESERVED1', 'SPSModifier', 'SBOPause',
    'SAFT16kHz16BitStereo', 'SLTApp', 'SPPROPERTYINFO',
    'DISPID_SPERequiredConfidence', 'DISPID_SPPChildren',
    'DISPID_SGRSAddRuleTransition', 'SAFTCCITT_ALaw_22kHzMono',
    'SPPS_Verb', 'WAVEFORMATEX', 'DISPID_SPPId', 'SPPHRASE',
    'STCInprocHandler', 'SP_VISEME_6', 'SLODynamic',
    'SPRST_NUM_STATES', 'ISpeechPhraseAlternate',
    'DISPID_SRDisplayUI', 'SpeechCategoryRecognizers',
    'DISPID_SRCPause', 'STCInprocServer', 'ISpeechPhraseProperties',
    'DISPID_SWFEFormatTag', 'SVP_2', 'SPDKL_CurrentConfig',
    'DISPID_SRGRules', 'SLTUser', 'DISPID_SGRId',
    'DISPID_SGRs_NewEnum', 'SREAllEvents', 'SpeechBookmarkOptions',
    'SGLexical', 'SPEI_MIN_TTS', '_ISpeechRecoContextEvents',
    'ISequentialStream', 'SP_VISEME_16', 'SAFT44kHz16BitMono',
    'DISPID_SLGetPronunciations', 'SpeechUserTraining',
    'DISPID_SOTCreateInstance', 'DISPID_SPANumberOfElementsInResult',
    'UINT_PTR', 'eLEXTYPE_PRIVATE14', 'SAFT22kHz16BitMono',
    'SREFalseRecognition', 'ISpRecognizer3', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRCResume', 'SGSEnabled', 'DISPID_SVEventInterests',
    'SP_VISEME_10', 'DISPID_SVIsUISupported', 'DISPID_SLWsCount',
    'ISpeechPhraseRules', 'DISPID_SRGCommit', 'SRTStandard',
    'DISPID_SRRSaveToMemory', 'SpeechGrammarTagWildcard',
    'SGDSActive', 'DISPID_SVAudioOutput', 'SPPS_Noncontent',
    'ISpeechLexiconWord', 'DISPID_SBSSeek', 'DISPID_SRCCreateGrammar',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPSVerb', 'SPSSuppressWord',
    ...
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRRTimes',
    'DISPID_SRCSetAdaptationData', 'SAFTADPCM_22kHzMono',
    'SPEI_RESERVED3', 'DISPID_SOTGetStorageFileName',
    'SECHighConfidence', 'SVEWordBoundary', 'SPXRO_SML',
    'SpMMAudioEnum', 'DISPID_SRGIsPronounceable',
    ...
    'eWORDTYPE_DELETED', 'ISpeechPhraseInfoBuilder',
    'SpStreamFormatConverter', 'DISPID_SMSSetData',
    'ISpeechLexiconPronunciation', 'SpNotifyTranslator', 'SpShortcut',
    'SAFT11kHz8BitStereo', 'eLEXTYPE_RESERVED9', 'SITooFast',
    'SPGS_ENABLED', 'DISPID_SOTGetAttribute', 'SPBO_NONE',
    'DISPID_SABIMinNotification', 'SVP_4', 'SAFT11kHz16BitStereo',
    'SAFTADPCM_44kHzStereo', 'ISpStreamFormat',
    'DISPID_SGRInitialState', 'ISpRecoContext2', 'SP_VISEME_19',
    'SVP_1', 'DISPID_SpeechRecoContextEvents',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SpeechWaveFormatEx', 'SpUnCompressedLexicon',
    'SpInprocRecognizer', 'SPEI_SOUND_END', 'SRESoundStart',
    'ISpLexicon', 'SDA_Consume_Leading_Spaces', 'SVEAudioLevel',
    'DISPID_SDKEnumKeys', 'SPDKL_DefaultLocation',
    'DISPID_SPRules_NewEnum', 'DISPID_SOTIsUISupported', 'SLOStatic',
    'SITooQuiet', 'DISPID_SDKOpenKey', 'SPEI_ADAPTATION',
    'DISPID_SPEActualConfidence', 'DISPID_SPAsCount',
    'DISPID_SRCEFalseRecognition', 'ISpeechPhraseElements',
    'DISPID_SRCState', 'SpeechAddRemoveWord',
    'DISPID_SRCEStartStream', 'SpeechEngineConfidence',
    'SpeechVoiceEvents', 'SRAInterpreter', 'DISPID_SpeechAudioFormat',
    'DISPID_SPPNumberOfElements', 'Speech_StreamPos_RealTime',
    'SVP_7', 'SAFT11kHz16BitMono', 'SECNormalConfidence',
    'DISPID_SRRAlternates', 'SPEI_PHONEME', 'SPSInterjection',
    'DISPID_SPPsCount', 'SPCT_COMMAND', 'eLEXTYPE_PRIVATE3',
    'SpeechLoadOption', 'SRADefaultToActive',
    'DISPID_SRRGetXMLErrorInfo', 'SGDSInactive', 'SPSUnknown',
    'SWPUnknownWordPronounceable', 'DISPID_SRRPhraseInfo',
    'SpeechDiscardType', 'SAFT22kHz16BitStereo'
]
